...
\abstract{
As the world is affected by the COVID-19 outbreak and its continuous growth, scientist are heavily researching the virus in order to find a cure. While having research teams from the whole world working on it, new findings and related papers are made on daily basis. For scientists to stay in touch with everything that's going on, they should somehow find the time to study these papers to see what progress has been made and how they could use it in their own research. To keep them busy with research and not with browsing for papers, we propose a solution in form of an information retrieval system that is adapted to the scientific domain of this problem. While using it, the most relevant papers for each of their COVID-19 related queries are retrieved saving precious time.
}
