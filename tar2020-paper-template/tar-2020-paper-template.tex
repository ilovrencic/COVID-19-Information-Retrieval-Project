...
\title{COVID-19 information retrieval system}
...
On the last day of 2019 there were reports of first cases from an previously-unknown virus which is today known as COVID-19. Only five months later, there are more than five million confirmed cases and more than 340,000 deaths. In situations like this when a new virus is discovered and causes a pandemic, it is important for scientists to get the latest information so they could apply them in their work. While the whole world researching it is a positive thing, the rapid growth of scientific papers and coronavirus related knowledge is making it nearly impossible for scientists to digest important data.

To tackle this problem, the White House and a coalition of leading research groups came with an initiative to prepare the COVID-19 Open Research Dataset (CORD-19). The dataset is containing over 128,000 scholarly articles about COVID-19, SARS-CoV-2 and other related coronaviruses. This freely available dataset is given to the global research community in order to apply natural language processing (NLP) and other AI techniques to generate new insights in support of the ongoing fight against this infectious disease.

In this paper we propose a solution for this problem by wrapping it as an information retrieval task. The goal is to satisfy the informational needs of scientists by obtaining the most relevant articles from the CORD-19 dataset. We adapt our IR system to the scientific domain of this task by adding biomedical named entity recognition (BioNER) filtering for coronavirus related articles. Later on we use sentence- and document-level embeddings to get more precise scores which are then all taken into the final score computation.

In the next section we discuss the approaches of other highly-ranked proposed solutions and compare them to our own. Next, in section 3. we are going to explain our approach in detail covering each step of the final IR system. Then there's the evaluation and results part which was pretty hard to do because of the dataset not being labeled and the lack of expert knowledge in this domain.  
